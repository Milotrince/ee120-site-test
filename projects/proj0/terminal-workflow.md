...
Download [python_basics.zip]({{ "/assets/projects/python_basics.zip" | relative_url }}) into your home directory (note: the zip file’s name may be slightly different when you download it). Use `unzip` to extract the contents of the zip file:

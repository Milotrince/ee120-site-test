...
You can download all of the files associated with the Python mini-tutorial as a zip archive: [python_basics.zip]({{ "/assets/projects/python_basics.zip" | relative_url }}). If you did the unix tutorial in the previous tab, you’ve already downloaded and unzipped this file.
